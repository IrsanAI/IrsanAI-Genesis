// scripts/validate-registry.ts — Build Gate EG 4e74a97 13/13 GRUEN for Genesis
const EG_BASE = 'https://raw.githubusercontent.com/IrsanAI/IrsanAI-Essence-Gate/main/registry/essences'
async function main(){
  console.log('[GENESIS:validate-registry] Genesis Consumer of EG 4e74a97 13/13 GRUEN')
  ...
  console.log('[GENESIS:validate-registry] '+ok+'/13 valid GRUEN — Single Source of Truth EG 4e74a97')
}
main()
